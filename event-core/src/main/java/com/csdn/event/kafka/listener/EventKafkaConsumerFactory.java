...
public class EventKafkaConsumerFactory {
    ...
    public KafkaConsumer<String, ?> buildKafkaConsumer(Class<?> clazz) {
        Properties props = new Properties();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaProperties.getBootstrapServers());
        props.put(ConsumerConfig.GROUP_ID_CONFIG, this.getGroupId(clazz));
     ...
     * @return 消费者组ID
     */
    private String getGroupId(Class<?> clazz) {
        return kafkaProperties.getConsumer().getGroupId() + "-" + clazz.getSimpleName();
    }
